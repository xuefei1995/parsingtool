...
import com.xuefei.service.deal.DBFDealData;

import javax.swing.*;
import java.awt.*;
import java.io.File;

public class DBFWindow implements Window {

    public void createWindow() {
        JFrame frame = new JFrame("解析DBF软件");
    ...
    private void createButton1(JFrame frame, JPanel panel, Param param) {
        JButton button = new JButton("请选择读取文件~");
        ...
        button.addActionListener(e -> {
            ...
            if (option == JFileChooser.APPROVE_OPTION) {
                ...
                label.setText("选择读取的文件为: " + file.getName());
            }
        });
        panel.add(button);
        panel.add(label);
    ...
    private void createButton3(JFrame frame, JPanel panel, Param param) {
        ...
        button.addActionListener(event -> {
            ...
            try {
                new DBFDealData().createData(param);
